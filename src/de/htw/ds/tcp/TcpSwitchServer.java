...
public class TcpSwitchServer implements Runnable, Closeable {
	...
	static private class ConnectionHandler implements Runnable {
		 ...
		 */
		public void run () {
			final String serverName = this.parent.host.getInetAddress().getHostName();
			final int serverPort = this.parent.getServicePort();
...
//				if (cause instanceof UnknownHostException) throw (UnknownHostException) cause;
